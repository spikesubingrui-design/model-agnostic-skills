...
~/.agent/skills/gstack/bin/gstack-timeline-log '{"skill":"retro","event":"started","branch":"'"$_BRANCH"'","session":"'"$_SESSION_ID"'"}' 2>/dev/null &
_HAS_ROUTING="no"
...
```bash
~/.agent/skills/gstack/bin/gstack-question-log '{"skill":"retro","question_id":"<id>","question_summary":"<short>","category":"<approval|clarification|routing|cherry-pick|feedback-loop>","door_type":"<one-way|two-way>","options_count":N,"user_choice":"<key>","recommended":"<key>","session_id":"'"$_SESSION_ID"'"}' 2>/dev/null || true
```
...
Generates a comprehensive engineering retrospective analyzing commit history, work patterns, and code quality metrics. Team-aware: identifies the user running the command, then analyzes every contributor with per-person praise and growth opportunities. Designed for a senior IC/CTO-level builder using Your coding agent as a force multiplier.
...
```bash
~/.agent/skills/gstack/bin/gstack-learnings-log '{"skill":"retro","type":"TYPE","key":"SHORT_KEY","insight":"DESCRIPTION","confidence":N,"source":"SOURCE","files":["path/to/relevant/file"]}'
```
...
```bash
DISCOVER_BIN=""
[ -x ~/.agent/skills/gstack/bin/gstack-global-discover ] && DISCOVER_BIN=~/.agent/skills/gstack/bin/gstack-global-discover
[ -z "$DISCOVER_BIN" ] && [ -x .agent/skills/gstack/bin/gstack-global-discover ] && DISCOVER_BIN=.agent/skills/gstack/bin/gstack-global-discover
...
- Behavioral patterns (e.g., "Codex used exclusively for myapp, Your coding agent for everything else")
...
- Your coding agent: N sessions across M repos — patterns observed
  ...
  "projects": [
    {
      ...
      "insertions": 3200,
      "deletions": 800,
      "sessions": { "coding_agent": 15, "codex": 3, "gemini": 0 }
    }
  ],
  "totals": {
    "commits": 182,
    ...
    "projects": 5,
    "active_days": 6,
    "sessions": { "coding_agent": 48, "codex": 8, "gemini": 3 },
...
- Do not read SKILL.md or other docs — this skill is self-contained
