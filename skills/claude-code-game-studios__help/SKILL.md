---
name: help
description: Studio Help — What Do I Do Next?
version: 1.0.0
...
Read `.agent/docs/workflow-catalog.yaml`. This is the authoritative list of all
...
After reading the catalog, Glob `.agent/skills/*/SKILL.md` to get the full list
