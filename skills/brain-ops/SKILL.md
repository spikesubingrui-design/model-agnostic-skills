---
name: brain-ops
description: Brain knowledge base: brain-first lookup, memory indexing, wiki sync, health checks. Model-agnostic.
version: 1.0.0
original: brain-ops (workspace gbrain)
...
tags: [agent, docs, review, planning]
---
