---
name: everything-claude-code__claude-devfleet
description: Claude DevFleet 多智能体编排
version: 1.0.0
...
当需要调度多个 Your coding agent 智能体并行处理编码任务时使用此技能。每个智能体在独立的 git worktree 中运行，并配备全套工具。
