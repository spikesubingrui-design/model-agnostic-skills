---
name: adopt
description: Adopt — Brownfield Template Adoption
version: 1.0.0
...
- `.agent/docs/technical-preferences.md` — engine configured?
...
Read `.agent/docs/technical-preferences.md`. Check each field for `[TO BE CONFIGURED]`:
