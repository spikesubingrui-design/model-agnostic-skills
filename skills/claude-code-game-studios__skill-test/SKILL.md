...
Validates `.agent/skills/*/SKILL.md` files for structural compliance and
...
- `static all` → run 7 structural checks on all skills (Glob `.agent/skills/*/SKILL.md`)
...
Glob `.agent/skills/*/SKILL.md` to get the complete list of skills.
