...
3. `.agent/docs/technical-preferences.md` — naming conventions, performance budgets,
...
Apply gate **TD-ARCHITECTURE** (`.agent/docs/director-gates.md`) as a self-review. Check all four criteria from that gate definition against the completed document.
...
**Step 2 — Spawn `lead-programmer` via Task using gate LP-FEASIBILITY (`.agent/docs/director-gates.md`):**
