...
Rust patterns, error handling, and anti-patterns are defined in `.agent/rules/rust-patterns.md` (auto-loaded into context). Key points:
...
Testing strategy and performance targets are defined in `.agent/rules/cli-testing.md` (auto-loaded). Key targets: <10ms startup, <5MB memory, 60-90% token savings.
