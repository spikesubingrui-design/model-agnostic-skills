---
name: setup-engine
description: [Engine] — Version Reference
version: 1.0.0
...
---
name: setup-engine
description: "Configure the project's game engine and version. Pins the engine in SKILL.md, detects knowledge gaps, and populates engine reference docs via WebSearch when the version is beyond the LLM's training data."
...
## 4. Update SKILL.md Technology Stack
...
Record the choice. It determines the SKILL.md template, naming conventions, specialist routing, and which agent is spawned for code files throughout the project.

---

Read `SKILL.md` and show the user the proposed Technology Stack changes.
Ask: "May I write these engine settings to `SKILL.md`?"
...
After updating SKILL.md, create or update `.agent/docs/technical-preferences.md` with
...
## 8. Update SKILL.md Import

Ask: "May I update the `@` import in `SKILL.md` to point to the new engine reference?"
...
### A1. SKILL.md Technology Stack Templates
