...
- Read `.agent/docs/technical-preferences.md` to identify the engine and version
...
Use the template structure from `.agent/docs/templates/game-design-document.md`:
...
Before finalizing the GDD, spawn `creative-director` via Task using gate **CD-GDD-ALIGN** (`.agent/docs/director-gates.md`).
...
> **To validate this GDD, open a fresh Your coding agent session and run:**
...
> open a fresh Your coding agent session and run `/design-system [system-name]` — it will
