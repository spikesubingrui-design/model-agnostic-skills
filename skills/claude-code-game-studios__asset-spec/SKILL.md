---
name: asset-spec
description: Asset Specs — [Target Type]: [Target Name]
version: 1.0.0
...
- **Technical preferences**: Read `.agent/docs/technical-preferences.md` — extract performance budgets and naming conventions.
