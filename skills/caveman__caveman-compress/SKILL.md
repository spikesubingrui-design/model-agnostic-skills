...
name: caveman-compress
description: >
  Compress natural language memory files (SKILL.md, todos, preferences) into caveman format
...
Compress natural language files (SKILL.md, todos, preferences) into caveman-speak to reduce input tokens. Compressed version overwrites original. Human-readable backup saved as `<filename>.original.md`.
