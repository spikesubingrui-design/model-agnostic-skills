---
name: everything-claude-code__search-first
description: /search-first — 编码前先研究
version: 1.0.0
...
2. 有对应的 MCP 吗？ → 检查 `~/.agent/settings.json` 并进行搜索
3. 有对应的技能吗？ → 检查 `~/.agent/skills/`
...
任务（子代理类型="通用型"，提示="
  ...
  搜索：npm/PyPI、MCP 服务器、Your coding agent 技能、GitHub
  返回：结构化对比与推荐
")
```
