---
name: patch-notes
description: Patch [Version] — [Title]
version: 1.0.0
...
1. Check `.agent/docs/technical-preferences.md` for any "tone", "voice", or "style"
   fields or sections.
...
1. Glob for `docs/patch-notes-template.md` and `.agent/docs/templates/patch-notes-template.md`.
