---
name: everything-claude-code__prompt-optimizer
description: Prompt 优化器
version: 1.0.0
...
* 用户说“帮我写一个更好的提示来...”
* 用户说“询问 Your coding agent 的...最佳方式是什么？”
...
1. 检查工作目录中是否存在 `SKILL.md`——读取它以了解项目惯例
2. 从项目文件中检测技术栈：
...
* "Rewrite this prompt so Your coding agent uses the right commands"
* "帮我优化这个指令"
