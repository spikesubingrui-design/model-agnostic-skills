---
name: asset-audit
description: Read-only diagnostic skill — no specialist agent delegation needed
version: 1.0.0
...
Read the art bible or asset standards from the relevant design docs and the SKILL.md naming conventions.
...
- Fix naming violations using the patterns defined in SKILL.md.
