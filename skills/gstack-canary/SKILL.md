---
name: gstack-canary
description: Post-deploy canary monitoring. Watches the live app for console errors,   performance regressions, and page failures using the browse daemon. Takes   periodic screenshots, compares against pre-deploy 
version: 1.0.0
original: garrytan/gstack/canary
