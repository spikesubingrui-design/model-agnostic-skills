...
Verify `.agent/skills/[name]/SKILL.md` exists. If not, stop with:
...
Read the full skill file at `.agent/skills/[name]/SKILL.md`.
...
Ask: "May I write this improved version to `.agent/skills/[name]/SKILL.md`?"
...
Write the improved skill to `.agent/skills/[name]/SKILL.md`.
...
Ask: "May I revert `.agent/skills/[name]/SKILL.md` using git checkout?"
If yes: run `git checkout -- .agent/skills/[name]/SKILL.md`
