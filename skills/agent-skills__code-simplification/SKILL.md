...
> Inspired by the [Your coding agent Simplifier plugin](https://github.com/anthropics/claude-plugins-official/blob/main/plugins/code-simplifier/agents/code-simplifier.md). Adapted here as a model-agnostic, process-driven skill for any AI coding agent.
...
```
1. Read SKILL.md / project conventions
...
- [ ] Simplified code follows project conventions (checked against SKILL.md or equivalent)
