---
name: everything-claude-code__agent-payment-x402
description: Agent Payment Execution (x402)
version: 1.0.0
...
The payment layer exposes standard MCP tools that slot into any Your coding agent or agent harness setup.
