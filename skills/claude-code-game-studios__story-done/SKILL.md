...
After completing the deviation checks in Phase 4, spawn `qa-lead` via Task using gate **QL-TEST-COVERAGE** (`.agent/docs/director-gates.md`).
...
Spawn `lead-programmer` via Task using gate **LP-CODE-REVIEW** (`.agent/docs/director-gates.md`).
