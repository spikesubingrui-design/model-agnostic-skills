---
name: everything-claude-code__workspace-surface-audit
description: Workspace Surface Audit
version: 1.0.0
...
---
name: workspace-surface-audit
description: Audit the active repo, MCP servers, plugins, connectors, env surfaces, and harness setup, then recommend the highest-value ECC-native skills, hooks, agents, and operator workflows. Use when the user wants help setting up Your coding agent or understanding what capabilities are actually available in their environment.
origin: ECC
---
...
- User says "set up Your coding agent", "recommend automations", "what plugins or MCPs should I use?", or "what am I missing?"
...
1. Repo surface
   ...
   - `.mcp.json`, `.lsp.json`, `.agent/settings*.json`, `.codex/*`
   - `AGENTS.md`, `SKILL.md`, install manifests, hook configs
