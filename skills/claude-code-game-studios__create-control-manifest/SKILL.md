...
description: Create Control Manifest
version: 1.0.0
...
- Read `.agent/docs/technical-preferences.md`
...
Spawn `technical-director` via Task using gate **TD-MANIFEST** (`.agent/docs/director-gates.md`).
