---
name: onboard
description: Onboarding: [Role/Area]
version: 1.0.0
...
Read SKILL.md for project overview and standards.

Read the relevant agent definition from `.agent/agents/` if a specific role is specified.
...
[Summary of conventions relevant to this role from SKILL.md and agent definition]
