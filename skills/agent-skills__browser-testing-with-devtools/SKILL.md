...
description: Browser Testing with DevTools
version: 1.0.0
...
```bash
# Add Chrome DevTools MCP server to your Your coding agent config
# In your project's .mcp.json or Your coding agent settings:
{
  "mcpServers": {
    "chrome-devtools": {
      "command": "npx",
