---
name: everything-claude-code__knowledge-ops
description: Knowledge Operations
version: 1.0.0
...
### Layer 2: Your coding agent Memory (Quick Access)
- **Path:** `~/.agent/projects/*/memory/`
...
- Always update Your coding agent memory for quick access
