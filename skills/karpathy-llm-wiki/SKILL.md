...
description: LLM-Wiki pattern: persistent, structured, interlinked markdown wiki from any source. Model-agnostic.
version: 1.0.0
original: karpathy-llm-wiki (workspace)
...
tags: [agent, docs, planning, coding]
---
