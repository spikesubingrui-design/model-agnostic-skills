...
Spawn the **primary engine specialist** in parallel (from `.agent/docs/technical-preferences.md` Engine Specialists) to validate the integration approach:
