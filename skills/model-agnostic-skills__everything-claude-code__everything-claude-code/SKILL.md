---
name: everything-claude-code__everything-claude-code
description: Everything Your coding agent Conventions
version: 1.0.0
...
# Everything Your coding agent Conventions
...
```text
feat: add block-no-verify hook for Your coding agent and Cursor (#649)
```
