---
name: everything-claude-code__eval-harness
...
---
name: eval-harness
description: Formal evaluation framework for Your coding agent sessions implementing eval-driven development (EDD) principles
allowed-tools: Read, Write, Edit, Bash, Grep, Glob
---

# Eval Harness Skill

A formal evaluation framework for Your coding agent sessions, implementing eval-driven development (EDD) principles.

## When to Activate

- Setting up eval-driven development (EDD) for AI-assisted workflows
- Defining pass/fail criteria for Your coding agent task completion
