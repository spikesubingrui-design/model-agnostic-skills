...
See `.agent/docs/director-gates.md` for the full check pattern and mode definitions.
...
Spawn `qa-lead` via Task using gate **QL-STORY-READY** (`.agent/docs/director-gates.md`).
