---
name: gstack-qa-only
description: Report-only QA testing. Systematically tests a web application and produces a   structured report with health score, screenshots, and repro steps — but never   fixes anything. Use when asked to "just 
version: 1.0.0
original: garrytan/gstack/qa-only
