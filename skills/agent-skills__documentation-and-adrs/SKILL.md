...
description: Documentation and ADRs
version: 1.0.0
...
- **SKILL.md / rules files** — Document project conventions so agents follow them
...
- [ ] Rules files (SKILL.md etc.) are current and accurate
