---
name: everything-claude-code__zh-CN
...
本文件为 Your coding agent (claude.ai/code) 处理此仓库代码时提供指导。

## 项目概述

这是一个 **Your coding agent 插件** - 一个包含生产就绪的代理、技能、钩子、命令、规则和 MCP 配置的集合。该项目提供了使用 Your coding agent 进行软件开发的经验证的工作流。
