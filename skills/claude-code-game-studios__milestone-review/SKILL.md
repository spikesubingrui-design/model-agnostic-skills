...
description: Milestone Review: [Milestone Name]
version: 1.0.0
...
Before generating the Go/No-Go recommendation, spawn `producer` via Task using gate **PR-MILESTONE** (`.agent/docs/director-gates.md`).
