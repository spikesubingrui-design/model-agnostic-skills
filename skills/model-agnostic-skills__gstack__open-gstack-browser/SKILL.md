---
name: gstack__open-gstack-browser
...
~/.agent/skills/gstack/bin/gstack-timeline-log '{"skill":"open-gstack-browser","event":"started","branch":"'"$_BRANCH"'","session":"'"$_SESSION_ID"'"}' 2>/dev/null &
_HAS_ROUTING="no"
...
```bash
~/.agent/skills/gstack/bin/gstack-question-log '{"skill":"open-gstack-browser","question_id":"<id>","question_summary":"<short>","category":"<approval|clarification|routing|cherry-pick|feedback-loop>","door_type":"<one-way|two-way>","options_count":N,"user_choice":"<key>","recommended":"<key>","session_id":"'"$_SESSION_ID"'"}' 2>/dev/null || true
```
...
_EXT_PATH=""
_ROOT=$(git rev-parse --show-toplevel 2>/dev/null)
[ -n "$_ROOT" ] && [ -f "$_ROOT/.agent/skills/gstack/extension/manifest.json" ] && _EXT_PATH="$_ROOT/.agent/skills/gstack/extension"
[ -z "$_EXT_PATH" ] && [ -f "$HOME/.agent/skills/gstack/extension/manifest.json" ] && _EXT_PATH="$HOME/.agent/skills/gstack/extension"
...
> it won't interfere with this Your coding agent window.
