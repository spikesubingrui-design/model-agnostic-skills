---
name: everything-claude-code__token-budget-advisor
description: Token Budget Advisor (TBA)
version: 1.0.0
...
Standalone skill from [TBA — Token Budget Advisor for Your coding agent](https://github.com/Xabilimon1/Token-Budget-Advisor-Claude-Code-).
