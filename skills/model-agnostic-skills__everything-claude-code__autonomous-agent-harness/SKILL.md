---
name: everything-claude-code__autonomous-agent-harness
description: Autonomous Agent Harness
version: 1.0.0
...
---
name: autonomous-agent-harness
description: Transform Your coding agent into a fully autonomous agent system with persistent memory, scheduled operations, computer use, and task queuing. Replaces standalone agent frameworks (Hermes, AutoGPT) by leveraging Your coding agent's native crons, dispatch, MCP tools, and memory. Use when the user wants continuous autonomous operation, scheduled tasks, or a self-directing agent loop.
origin: ECC
---

# Autonomous Agent Harness

Turn Your coding agent into a persistent, self-directing agent system using only native features and MCP servers.
...
Use Your coding agent's built-in memory system enhanced with MCP memory server for structured data.

**Built-in memory** (`~/.agent/projects/*/memory/`):
...
Write to ~/.agent/projects/*/memory/ for cross-session recall
...
Use Your coding agent's scheduled tasks to create recurring agent operations.
...
Trigger Your coding agent agents remotely for event-driven workflows.
...
Write task queue to ~/.agent/projects/*/memory/task-queue.md
...
|------------------|---------------|-----|
| Gateway/Router | Your coding agent dispatch + crons | Scheduled tasks trigger agent sessions |
