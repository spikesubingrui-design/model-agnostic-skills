...
~/.agent/skills/gstack/bin/gstack-timeline-log '{"skill":"browse","event":"started","branch":"'"$_BRANCH"'","session":"'"$_SESSION_ID"'"}' 2>/dev/null &
_HAS_ROUTING="no"
...
`$B` is the browse binary (resolved from `$_ROOT/.agent/skills/gstack/browse/dist/browse` or `~/.agent/skills/gstack/browse/dist/browse`).
