...
**Personal skills live in agent-specific directories (`~/.agent/skills` for Your coding agent, `~/.agents/skills/` for Codex)** 
...
- Project-specific conventions (put in SKILL.md)
