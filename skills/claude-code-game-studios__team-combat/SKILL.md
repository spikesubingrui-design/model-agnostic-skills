...
- **engine specialist** (primary) — Validate architecture and implementation patterns are idiomatic for the engine (read from `.agent/docs/technical-preferences.md` Engine Specialists section)
